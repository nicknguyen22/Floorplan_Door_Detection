...
src_path = os.path.join(current_path,"Keras_yolov3" ,"src")
...
Image_Folder = os.path.join(Data_Folder, "Dataset", "Train_output")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help="Number of epochs for training last layers and number of epochs for fine-tuning layers. Default is 100.",
    )
    parser.add_argument(
        "--warnings",
        default=False,
    ...
    input_shape = (608, 608)  # multiple of 32, height, width
    ...
    if _has_wandb:
        wandb.init(
            project="YOLOKeras", config=vars(FLAGS), sync_tensorboard=False
        )
